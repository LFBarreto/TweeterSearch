...
class FOSUBUserProvider extends BaseClass
{
    ...
    public function loadUserByOAuthUserResponse(UserResponseInterface $response)
    {
        ...
        $user = $this->myloadUserByOAuthUserResponse($response);
    ...
    /**
     * loadUser with email instead of username id
     */
    public function myloadUserByOAuthUserResponse(UserResponseInterface $response)
    {
        $email = $response->getEmail();
